...
export class DeckfishGame extends GameBase {
    public static readonly gameinfo: APGamesInformation = {
        ...
        flags: ["scores", "random-start", "no-moves", "custom-randomization", "experimental"],
    };
    ...
    constructor(state: number | IDeckfishState | string, variants?: string[]) {
        super();
    ...
    public validateMove(m: string): IValidationResult {
        ...
        if (!this.hands[this.currplayer - 1].includes(card)) {
            result.valid = false;
            result.message = i18next.t("apgames:validation.deckfish.NO_CARD", {card});
            return result;
        }
    ...
    public clone(): DeckfishGame {
        ...
        return Object.assign(new DeckfishGame(this.numplayers), deepclone(this) as DeckfishGame);
    }
}
