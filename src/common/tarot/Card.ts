...
export const majorCards: MajorCard[] = [
    { seq: 0, name: "The Fool", icons: ["gnostica-cardQuestion", "gnostica-cardQuestion"]},
    { seq: 1, name: "The Magician", icons: ["gnostica-allSuits"]},
    { seq: 2, name: "The High Priestess", icons: ["gnostica-hand", "gnostica-hand"]},
    { seq: 3, name: "The Empress", icons: ["gnostica-tip", "gnostica-cupWild"]},
    { seq: 4, name: "The Emperor", icons: ["gnostica-tip", "gnostica-wandWild"]},
    { seq: 5, name: "The Hierophant", icons: ["gnostica-transform"]},
    { seq: 6, name: "The Lovers", icons: ["gnostica-wand", "gnostica-cup"]},
    { seq: 7, name: "The Chariot", icons: ["gnostica-wand", "gnostica-wand"]},
    { seq: 8, name: "Strength", icons: ["gnostica-star", "gnostica-star"]},
    { seq: 9, name: "The Hermit", icons: ["gnostica-fly"]},
    { seq: 10, name: "Wheel of Fortune", icons: ["gnostica-cupQuestion"]},
    { seq: 11, name: "Justice", icons: ["gnostica-handTrade", "gnostica-sword"]},
    { seq: 12, name: "The Hanged Man", icons: ["gnostica-wand", "gnostica-tradeHands"]},
    { seq: 13, name: "Death", icons: ["gnostica-sword", "gnostica-sword"]},
    { seq: 14, name: "Temperance", icons: ["gnostica-cup", "gnostica-cup"]},
    { seq: 15, name: "The Devil", icons: ["gnostica-tip", "gnostica-tip", "gnostica-tip"]},
    { seq: 16, name: "The Tower", icons: ["gnostica-tip", "gnostica-swordCycle"]},
    { seq: 17, name: "The Star", icons: ["gnostica-tip", "gnostica-starCycle"]},
    { seq: 18, name: "The Moon", icons: ["gnostica-wand", "gnostica-sword"]},
    { seq: 19, name: "The Sun", icons: ["gnostica-cup", "gnostica-star"]},
    { seq: 20, name: "Judgement", icons: ["gnostica-handCycle"]},
    { seq: 21, name: "The World", icons: ["gnostica-chameleon"]},
